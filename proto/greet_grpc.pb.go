...
type GreetUserServiceClient interface {
	GreetUser(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *greetUserServiceClient) GreetUser(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.GreetUserService/GreetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetUserServiceServer interface {
	GreetUser(context.Context, *Request) (*Response, error)
...
func (UnimplementedGreetUserServiceServer) GreetUser(context.Context, *Request) (*Response, error) {
...
func _GreetUserService_GreetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.GreetUserService/GreetUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetUserServiceServer).GreetUser(ctx, req.(*Request))
	}
...
var GreetUserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.GreetUserService",
